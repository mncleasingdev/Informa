    ...
    <script type="text/javascript">
        ...
        function cplMain_EndCallback(s, e) {
            switch (cplMain.cpCallbackParam) {
                ...
                case "CANCEL":
                    ...
                    break;
                case "TBO":
                    var myLayout = FormLayout.GetItemByName("liTBO");
                    var myLayout2 = FormLayout.GetItemByName("liRefMemo");
                    

                    if (cplMain.cpVisible != null) {
                        myLayout.SetVisible(cplMain.cpVisible);
                        myLayout2.SetVisible(cplMain.cpVisible);

                        
                        luDeviasiMemo.SetValue(null);
                    }
                    ...
                    gvDetailDeviasi.Refresh();
                    break;
                case "DEVIASI_CHANGE":
                    txtNamaDebDeviasi.SetText(cplMain.cpDevNama);
                    txtNoPFKDeviasi.SetText(cplMain.cpDevNoPFK);
                    txtUnitDeviasi.SetText(cplMain.cpDevUnit);
                    txtJenisPembiayaanDeviasi.SetText(cplMain.cpDevJP);
                    txtNamaPengelolaDeviasi.SetText(cplMain.cpDevNamaAO);
        ...
        function onAssetDescEndCallback(s, e) {
            if (isResetRequired) {
                ...
                gvDetailCrossColl.GetEditor("colYEAR").Clear();
                gvDetailCrossColl.GetEditor("colPlafond").Clear();
            }
        }
        function onSelectedAssetChanged(s) {
            gvDetailCrossColl.GetEditor("colYEAR").SetValue(s.GetSelectedItem().GetColumnText('Year'));
            gvDetailCrossColl.GetEditor("colPlafond").SetValue(s.GetSelectedItem().GetColumnText('NTF'));
        }
        function onSelectedPendingGiroAgreementNoChanged(s) {
            ...
            gvDetailPendingGiro.GetEditor("colOverdue").SetValue(s.GetSelectedItem().GetColumnText('OVERDUE'));
        ...
        function onFreeTextInit(s) {
            ...
            //reFullDoc.commands.updateAllFields.execute();
            //reFullDoc.commands.showAllFieldCodes.execute(false);

            //cplMain.PerformCallback("FREETEXT;");
        }

        function onFreeTextEndCallBack() {
            cplMain.PerformCallback("FREETEXT2;");
        }

        function OnFreeTextHeaderChange() {

        }

        function OnrbtTBOChanged(rbtTBO) {
            if (rbtTBO.GetValue() != "") {
                cplMain.PerformCallback("TBO;" + rbtTBO.GetValue().toString());
            }
        }
        function OnluAccNoChanged(s, e) {
            var grid = luAccNo.GetGridView();
            grid.GetRowValues(grid.GetFocusedRowIndex(), 'DEBITUR;DEBITUR', OnGetSelectedFieldValues1);
        }

        function OnluAccNoChanged2(s, e) {
            var grid = luAccNo_ex.GetGridView();
            grid.GetRowValues(grid.GetFocusedRowIndex(), 'DEBITUR;DEBITUR', OnGetSelectedFieldValues2);
        }

        function OnGetSelectedFieldValues1(selectedValues) {
            txtDebiturNameDeviasi.SetValue(selectedValues[1]);
        }

        function OnGetSelectedFieldValues2(selectedValues2) {
            txtDebiturNameException.SetValue(selectedValues2[1]);
        }
    </script>
                                ...
                                <dx:LayoutItem ShowCaption="False" ColSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                            ...
                                            <dx:ASPxMemo runat="server" ID="mmReturnNote" ClientInstanceName="mmReturnNote" ClientVisible="false" Width="100%" Height="50px" Theme="Aqua">
                                            </dx:ASPxMemo>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
        ...
        <Items>
            <dx:LayoutGroup ShowCaption="True" GroupBoxDecoration="Box" Caption="Internal Memo New Entry" ColCount="4">
                <Items>
                    ...
                    <dx:EmptyLayoutItem></dx:EmptyLayoutItem>
                    <dx:EmptyLayoutItem></dx:EmptyLayoutItem>
                    <dx:LayoutItem Name="liNoteReturn" ShowCaption="True" Caption="Note Return">
                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxMemo runat="server" ID="mmReturnText" ClientInstanceName="mmReturnText" Width="100%" Height="75px" Theme="Aqua" NullText="">
                                </dx:ASPxMemo>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    ...
                    <dx:TabbedLayoutGroup Name="tbLayoutGroup" ClientInstanceName="tbLayoutGroup" Height="100px" Width="100%" ActiveTabIndex="0" Border-BorderStyle="Solid" Border-BorderWidth="0" Border-BorderColor="#d1ecee">
                        ...
                        <Items>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataComboBoxColumn Name="colDescription" ShowInCustomizationForm="True" FieldName="AssetDesc" Caption="Asset Description">
                                                            ...
                                                            <PropertiesComboBox EnableCallbackMode="true" ClientInstanceName="AssetDesc" DropDownRows="10" IncrementalFilteringDelay="500" ItemStyle-Wrap="True" IncrementalFilteringMode="Contains" DisplayFormatString="{0}" TextFormatString="{0}" DropDownStyle="DropDownList" ValueField="Description" TextField="Description">
                                                                <ClientSideEvents EndCallback="onAssetDescEndCallback" SelectedIndexChanged="function(s,e) {onSelectedAssetChanged(s);}"/>
                                                                <ItemStyle Wrap="True"></ItemStyle>
                                                                <Columns>
                                                                    <dx:ListBoxColumn FieldName="Description" Caption="Asset Desc" />
                                                                    <dx:ListBoxColumn FieldName="Year" Caption="Year" />
                                                                    <dx:ListBoxColumn FieldName="NTF" Caption="NTF" />
                                                                </Columns>
                                                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="ValidationSave" Display="Dynamic" ErrorDisplayMode="ImageWithText">
                                                                    <RequiredField ErrorText="* Value can't be empty." IsRequired="true" />
                                                                </ValidationSettings>
                                            ...
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridView
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataComboBoxColumn Name="colAgreement" FieldName="AgreementNo" ShowInCustomizationForm="True" Caption="Agreement">
                                                            ...
                                                            <PropertiesComboBox EnableCallbackMode="true" ClientInstanceName="AgreementNo" DropDownRows="10" IncrementalFilteringDelay="500" ItemStyle-Wrap="True" IncrementalFilteringMode="Contains" DisplayFormatString="{0}" TextFormatString="{0} {1}" DropDownStyle="DropDownList" ValueField="NO KONTRAK" TextField="NO KONTRAK">
                                                                ...
                                                                <Columns>
                                                                    <dx:ListBoxColumn FieldName="NO KONTRAK" Caption="Agreement" />
                                                                    <dx:ListBoxColumn FieldName="Debitur" Caption="Debitur" />
                                                                    <dx:ListBoxColumn FieldName="OVERDUE" Caption="Overdue" />
                                                                </Columns>
                                                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="ValidationSave" Display="Dynamic" ErrorDisplayMode="ImageWithText">
                                                                    <RequiredField ErrorText="* Value can't be empty." IsRequired="true" />
                                                                </ValidationSettings>
                                                        ...
                                                        <dx:GridViewDataTextColumn Name="colOverdue" FieldName="GiroOverdue" Caption="Overdue" ShowInCustomizationForm="True" ReadOnly="true">
                                                            <PropertiesTextEdit Style-BackColor="#f7faff"></PropertiesTextEdit>
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
                            ...
                            <dx:LayoutGroup Name="lgDeviasiMemo" GroupBoxDecoration="Box" Caption="Memo Deviasi" GroupBoxStyle-Caption-BackColor="White" ColCount="2" Visible="false">
                                <Items>
                                    <dx:LayoutItem ShowCaption="true" Caption="Perpanjangan?">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxRadioButtonList runat="server" ID="rbtTBO" ClientInstanceName="rbtTBO" Border-BorderStyle="None" RepeatColumns="0" ValueType="System.String" Font-Size="8">
                                                    <ClientSideEvents Init="function(s, e) { OnrbtTBOChanged(s); }" SelectedIndexChanged="function(s, e) { OnrbtTBOChanged(s); }" />
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Caption="TBO ke" Name="liTBO" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtTBODeviasi" ClientInstanceName="txtTBODeviasi" Theme="Aqua" Text="Generate By System" ReadOnly="true" Visible="true"></dx:ASPxTextBox>
                                                
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Ref Memo" Name="liRefMemo" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtRefMemoDeviasi" ClientInstanceName="txtRefMemoDeviasi" Theme="Aqua" Visible="false"></dx:ASPxTextBox>
                                                <dx:ASPxGridLookup
                                                    runat="server"
                                                    ID="luDeviasiMemo"
                                                    ClientInstanceName="luDeviasiMemo" OnDataBinding="luDeviasiMemo_DataBinding"
                                                    AutoGenerateColumns="False"
                                                    DisplayFormatString="{1}"
                                                    TextFormatString="{1}"
                                                    KeyFieldName="DocKey"
                                                    ...
                                                    Theme="Aqua"
                                                    Width="250px"
                                                    GridViewProperties-EnablePagingCallbackAnimation="true" AnimationType="Slide">
                                                    <ClientSideEvents ValueChanged="function(s,e) { cplMain.PerformCallback('DEVIASI_CHANGE;' + 'CHANGE'); }" />
                                                    <GridViewProperties>
                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" EnableRowHotTrack="true" />
                                                        <Settings ShowFilterBar="Hidden" ShowFilterRow="false" ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowHeaderFilterButton="True" ShowStatusBar="Visible" />
                                                        <SettingsSearchPanel ShowApplyButton="True" ShowClearButton="True" Visible="True" />
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataColumn Caption="DocKey" FieldName="DocKey" ShowInCustomizationForm="True" VisibleIndex="0" Visible="false">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="DocNo" FieldName="DocNo" ShowInCustomizationForm="True" VisibleIndex="1">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="MemoTo" FieldName="MemoTo" ShowInCustomizationForm="True" VisibleIndex="2">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="MemoCC" FieldName="MemoCC" ShowInCustomizationForm="True" VisibleIndex="3">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="MemoPerihal" FieldName="MemoPerihal" ShowInCustomizationForm="True" VisibleIndex="4">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="MemoFrom" FieldName="MemoFrom" ShowInCustomizationForm="True" VisibleIndex="5">
                                                        </dx:GridViewDataColumn>
                                                    </Columns>
                                                    <%--<GridViewStyles AdaptiveDetailButtonWidth="22"></GridViewStyles>--%>
                                                </dx:ASPxGridLookup>
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Caption="Ketegori" Width="360px">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxComboBox runat="server" ID="cbKategoriDeviasi" ClientInstanceName="cbKategoriDeviasi" 
                                                    Theme="Aqua" NullText="-- Select --">
                                                    <Items>
                                                        <dx:ListEditItem Value="1" Text="Dokumen Kredit" />
                                                        <dx:ListEditItem Value="2" Text="Dokumen Legalitas" />
                                                        <dx:ListEditItem Value="3" Text="Dokumen Kontrak" />
                                                        <dx:ListEditItem Value="4" Text="Dokumen Tagihan" />
                                                        <dx:ListEditItem Value="5" Text="Dokumen Jaminan" />
                                                        <dx:ListEditItem Value="6" Text="PDC" />
                                                        <dx:ListEditItem Value="7" Text="Dokumen Lain-Lain" />
                                                    </Items>
                                                </dx:ASPxComboBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama" Width="360px" Visible="false">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNamaDebDeviasi" ClientInstanceName="txtNamaDebDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                                
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="No PFK" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNoPFKDeviasi" ClientInstanceName="txtNoPFKDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Unit" Width="360px" Visible="true">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtUnitDeviasi" ClientInstanceName="txtUnitDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <%--<dx:LayoutItem ShowCaption="True" Caption="Client" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtCIFDeviasi" ClientInstanceName="txtCIFDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>--%>
                                    <dx:LayoutItem ShowCaption="True" Caption="Client No" Name="luAcc" Width="360px">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridLookup
                                                    ...
                                                    <ClientSideEvents ValueChanged="function(s,e) { cplMain.PerformCallback('CIF_ONCHANGE;' + 'CHANGE'); }" />
                                                    ...
                                                    <Columns>
                                                        <dx:GridViewDataColumn Caption="CIF" FieldName="CIF" ShowInCustomizationForm="True" VisibleIndex="1">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="Client Name" FieldName="DEBITUR" ShowInCustomizationForm="True" VisibleIndex="2">
                                                        </dx:GridViewDataColumn>
                                                    </Columns>
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Name="luAcc2" Caption="Client No" Width="360px" Visible="false">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="luAccNo2" ClientInstanceName="luAccNo2" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Jenis Pembiayaan" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtJenisPembiayaanDeviasi" ClientInstanceName="txtJenisPembiayaanDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama Debitur" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtDebiturNameDeviasi" ClientInstanceName="txtDebiturNameDeviasi" Width="100%" Theme="Aqua" ClientEnabled="true"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama AO Pengelola" Width="360px" >
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNamaPengelolaDeviasi" ClientInstanceName="txtNamaPengelolaDeviasi" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Name="ActPlan" ShowCaption="True" Caption="Keterangan Debitur" Width="360px" Height="30px">
                                    <CaptionSettings Location="Left"/>
                                    <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxMemo runat="server" ID="mmActionPlan" ClientInstanceName="mmActionPlan" Height="70px" Theme="Aqua">
                                                <HelpTextSettings DisplayMode="Popup"></HelpTextSettings>
                                                <HelpTextStyle ForeColor="DarkGreen"></HelpTextStyle>
                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="ValidationSave">
                                                    <RequiredField ErrorText="* Value can't be empty." IsRequired="True" />
                                    ...
                                    <dx:EmptyLayoutItem></dx:EmptyLayoutItem>
                                    <dx:LayoutItem Name="btnView" ShowCaption="false" Caption="View Detail Application" Width="10%">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxButton ID="btnViewDtl" runat="server" Font-Bold="true" ClientInstanceName="btnViewDtl" OnClick="btnViewDtl_Click" Text="View Detail Application" ClientVisible="true" Width="35%" RenderMode="Link" AutoPostBack="false" HorizontalAlign="Left" VerticalAlign="Middle">
                                                </dx:ASPxButton>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridView
                                                    runat="server"
                                                    ID="gvDetailDeviasi"
                                                    ClientInstanceName="gvDetailDeviasi"
                                                    Width="100%"
                                                    AutoGenerateColumns="False"
                                                    EnableCallBacks="true"
                                                    EnablePagingCallbackAnimation="true"
                                                    Font-Names="Calibri" Font-Size="9" ForeColor="#142e5d" KeyFieldName="DtlKey"
                                                    OnDataBinding="gvDetailDeviasi_DataBinding" OnCustomColumnDisplayText="gvDetailDeviasi_CustomColumnDisplayText" OnRowInserting="gvDetailDeviasi_RowInserting"
                                                    OnRowUpdating="gvDetailDeviasi_RowUpdating" OnRowDeleting="gvDetailDeviasi_RowDeleting"
                                                    Theme="Aqua">
                                                    <SettingsAdaptivity AdaptivityMode="HideDataCellsWindowLimit" AllowOnlyOneAdaptiveDetailExpanded="True" HideDataCellsAtWindowInnerWidth="700"></SettingsAdaptivity>
                                                    <ClientSideEvents />
                                                    <Settings ShowFilterRow="false" ShowGroupPanel="false" ShowFilterRowMenu="false" ShowFilterBar="Auto" ShowHeaderFilterButton="false" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataMemoColumn Name="colPerihal" FieldName="Perihal" Caption="Perihal" ShowInCustomizationForm="True" ReadOnly="false">
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                            <PropertiesMemoEdit Height="100px"></PropertiesMemoEdit>
                                                        </dx:GridViewDataMemoColumn>
                                                        <dx:GridViewDataMemoColumn Name="colAlasan" FieldName="Alasan" Caption="Alasan" ShowInCustomizationForm="True" ReadOnly="false">
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                            <PropertiesMemoEdit Height="100px"></PropertiesMemoEdit>
                                                        </dx:GridViewDataMemoColumn>
                                                        <dx:GridViewDataMemoColumn Name="colActionPlan" FieldName="Action" Caption="Action Plan" ShowInCustomizationForm="True" ReadOnly="false">
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                            <PropertiesMemoEdit Height="100px"></PropertiesMemoEdit>
                                                        </dx:GridViewDataMemoColumn>
                                                        <dx:GridViewDataDateColumn Name="colTglDeadline" FieldName="Deadline" Caption="Deadline" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy" ReadOnly="false">
                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                        </dx:GridViewDataDateColumn>
                                                    </Columns>
                            ...
                            <dx:LayoutGroup Name="lgExceptionMemo" GroupBoxDecoration="Box" Caption="Memo Exception" GroupBoxStyle-Caption-BackColor="White" ColCount="2" Visible="false">
                                <Items>
                                    <dx:LayoutItem ShowCaption="True" Caption="Ketegori" Width="360px">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxComboBox runat="server" ID="cbKategoriException" ClientInstanceName="cbKategoriException" Width="100%" Theme="Aqua" NullText="-- Select --">
                                                    <Items>
                                                        <dx:ListEditItem Value="1" Text="Dokumen Kredit" />
                                                        <dx:ListEditItem Value="2" Text="Dokumen Legalitas" />
                                                        <dx:ListEditItem Value="3" Text="Dokumen Kontrak" />
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama" Visible="false" Width="360px">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNamaDebException" ClientInstanceName="txtNamaDebException" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="No PFK" Width="360px">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNoCRException" ClientInstanceName="txtNoCRException" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Unit" Visible="true" Width="360px">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtUnitException" ClientInstanceName="txtUnitException" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Client No" Name="luAcc_ex" Width="360px">
                                        <CaptionSettings Location="Left" />
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridLookup
                                                    runat="server"
                                                    ID="luAccNo_ex"
                                                    ClientInstanceName="luAccNo_ex"
                                                    OnDataBinding="luAccNo_ex_DataBinding"
                                                    AutoGenerateColumns="False"
                                                    DisplayFormatString="{0}"
                                                    TextFormatString="{0}"
                                                    KeyFieldName="CIF"
                                                    ...
                                                    <HelpTextSettings DisplayMode="Popup"></HelpTextSettings>
                                                    <HelpTextStyle ForeColor="DarkGreen"></HelpTextStyle>
                                                    <ClientSideEvents ValueChanged="function(s,e) { cplMain.PerformCallback('CIF2_ONCHANGE;' + 'CHANGE'); }" />
                                                    <GridViewProperties EnablePagingCallbackAnimation="true">
                                                        <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="True" EnableRowHotTrack="true" />
                                                        <Settings ShowFilterBar="Hidden" ShowFilterRow="false" ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowHeaderFilterButton="True" ShowStatusBar="Visible" />
                                                        <SettingsSearchPanel ShowApplyButton="True" ShowClearButton="True" Visible="True" />
                                    ...
                                    <dx:LayoutItem ShowCaption="True" Name="luAccNo_Ex_2" Caption="Client No" Width="360px" Visible="false">
                                        <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="luAccNo_Ex_2" ClientInstanceName="luAccNo_Ex_2" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Jenis Pembiayaan" Width="360px">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtJenisPembiayaanException" ClientInstanceName="txtJenisPembiayaanException" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama Debitur" Width="360px" >
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtDebiturNameException" ClientInstanceName="txtDebiturNameException" Width="100%" Theme="Aqua" ClientEnabled="true"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem ShowCaption="True" Caption="Nama AO Pengelola" Width="360px">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxTextBox runat="server" ID="txtNamaPengelolaException" ClientInstanceName="txtNamaPengelolaException" Width="100%" Theme="Aqua"></dx:ASPxTextBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Name="ActPlan_exception" ShowCaption="True" Caption="Keterangan Debitur" Width="360px" Height="30px">
                                    <CaptionSettings Location="Left"/>
                                    <CaptionStyle Font-Bold="true" ForeColor="#1872c4"></CaptionStyle>
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxMemo runat="server" ID="mmActionPlan_exception" ClientInstanceName="mmActionPlan_exception" Height="70px" Theme="Aqua">
                                                <HelpTextSettings DisplayMode="Popup"></HelpTextSettings>
                                                <HelpTextStyle ForeColor="DarkGreen"></HelpTextStyle>
                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="ValidationSave">
                                                    <RequiredField ErrorText="* Value can't be empty." IsRequired="True" />
                                    ...
                                    <dx:EmptyLayoutItem></dx:EmptyLayoutItem>
                                    <dx:LayoutItem Name="btnView_excpt" ShowCaption="false" Caption="View Detail Application" CaptionStyle-Font-Bold="true" Width="10%">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxButton ID="btnView_excpt" runat="server" Font-Bold="true" ClientInstanceName="btnView_excpt" OnClick="btnView_excpt_Click" Text="View Detail Application" ClientVisible="true" Width="35%" RenderMode="Link" AutoPostBack="false" HorizontalAlign="Left" VerticalAlign="Middle">
                                                </dx:ASPxButton>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    ...
                                    <dx:LayoutItem ShowCaption="False" Width="100%">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridView
                                                    runat="server"
                                                    ID="gvDetailException"
                                                    ClientInstanceName="gvDetailException"
                                                    Width="100%"
                                                    AutoGenerateColumns="False"
                                                    EnableCallBacks="true"
                                                    EnablePagingCallbackAnimation="true"
                                                    Font-Names="Calibri" Font-Size="9" ForeColor="#142e5d" KeyFieldName="DtlKey"
                                                    OnDataBinding="gvDetailException_DataBinding" OnCustomColumnDisplayText="gvDetailException_CustomColumnDisplayText" OnRowInserting="gvDetailException_RowInserting"
                                                    OnRowUpdating="gvDetailException_RowUpdating" OnRowDeleting="gvDetailException_RowDeleting"
                                                    Theme="Aqua">
                                                    <SettingsAdaptivity AdaptivityMode="HideDataCellsWindowLimit" AllowOnlyOneAdaptiveDetailExpanded="True" HideDataCellsAtWindowInnerWidth="700"></SettingsAdaptivity>
                                                    <ClientSideEvents />
                                                    <Settings ShowFilterRow="false" ShowGroupPanel="false" ShowFilterRowMenu="false" ShowFilterBar="Auto" ShowHeaderFilterButton="false" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataMemoColumn Name="colActionPlan" FieldName="MitigasiResiko" Caption="Mitigasi Resiko" ShowInCustomizationForm="True" ReadOnly="false">
                                                            <HeaderStyle Font-Bold="true" ForeColor="#1872c4" />
                                                            <PropertiesMemoEdit Height="100px"></PropertiesMemoEdit>
                                                        </dx:GridViewDataMemoColumn>
                                                    </Columns>
                                    ...
                                    <dx:LayoutItem ShowCaption="False" HorizontalAlign="Center" Width="100%" ColSpan="4">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                ...
                                                <dx:ASPxRichEdit ID="reTemplate" runat="server" ClientInstanceName="reTemplate" OnCalculateDocumentVariable="reTemplate_CalculateDocumentVariable" ShowConfirmOnLosingChanges="false" ViewStateMode="Disabled" Width="100%" OnPreRender="reTemplate_PreRender" OnInit="reTemplate_Init">
                                                    <Settings>
                                                        <Behavior CreateNew="Hidden" SaveAs="Disabled" Open="Disabled" Save="Disabled"/>
                                                    </Settings>
                                                ...
                                                <%--<dx:ASPxRichEdit ID="reFullDoc" runat="server" ClientInstanceName="reFullDoc" OnCalculateDocumentVariable="reFullDoc_CalculateDocumentVariable" ShowConfirmOnLosingChanges="false" ViewStateMode="Disabled" Width="100%" OnPreRender="reFullDoc_PreRender" OnInit="reFullDoc_Init">
                                                    <Settings>
                                                        <Behavior CreateNew="Hidden" SaveAs="Disabled" Open="Disabled" Save="Disabled"/>
                                                    </Settings>
                                                    <ClientSideEvents Init="onFreeTextInit"/>
                            ...
                            <dx:LayoutGroup Name="lgMemoStateHistory" GroupBoxDecoration="Box" Caption="History" GroupBoxStyle-Caption-BackColor="White" ColCount="4" Visible="true">
                                <Items>
                                    <dx:LayoutItem ShowCaption="False" Width="100%">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxGridView
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Name="colId" Caption="Id" FieldName="id" ReadOnly="True" Visible="false" VisibleIndex="2">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Name="colDocKey" Caption="DocKey" FieldName="DocKey" ReadOnly="True" ShowInCustomizationForm="true" Visible="false" VisibleIndex="3">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        ...
                                                        <dx:GridViewDataTextColumn Name="colNama" FieldName="Nama" ShowInCustomizationForm="True" Caption="Nama" ReadOnly="true" Width="10%">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Name="colDecisionState" FieldName="State" Caption="State" ReadOnly="true" Width="10%">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataDateColumn Name="colDecisionDate" FieldName="DateState" Caption="Decision Date" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" ReadOnly="true" Width="10%">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        </dx:GridViewDataDateColumn>
                                                        <dx:GridViewDataMemoColumn Name="colDecisionNote" FieldName="Note" Caption="Note" ReadOnly="true" PropertiesMemoEdit-Height="16px">
                                                            <HeaderStyle Font-Bold="true" BackColor="#f0f0f0" ForeColor="#1872c4" />
                                                        </dx:GridViewDataMemoColumn>
                                                    </Columns>
                                                </dx:ASPxGridView>
            ...
            <dx:LayoutItem ShowCaption="False" Width="10%">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxButton runat="server" ID="btnCancel" ClientInstanceName="btnCancel" Text="Cancel" AutoPostBack="false" Theme="Aqua" ForeColor="Red" ClientVisible="false">
            ...
            <dx:LayoutItem ShowCaption="False" Width="10%">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                        <dx:ASPxButton runat="server" ID="btnBackToCreator" ClientInstanceName="btnBackToCreator" Text="Return" AutoPostBack="false" Theme="Aqua" ClientVisible="false">
