...
namespace DXMNCGUI_INFORMA.Transaction.InternalMemo
{
    public class InternalMemoDB
    {
        ...
        protected DataTable myHistoryState;
        ...
        public long DeviasiDtlKeyUniqueKey()
        {
            return this.myDBReg.IncOne((IRegistryID)new InternalMemoDeviasiDtlKey());
        }
        public long ExceptionDtlKeyUniqueKey()
        {
            return this.myDBReg.IncOne((IRegistryID)new InternalMemoExceptionDtlKey());
        }
        ...
        private void InitHeaderRow(DataRow row, DXIType type, string sDocTypeValue)
        {
            ...
            row["NoteReturn"] = DBNull.Value;
            row["DeviasiNoPFK"] = DBNull.Value;
            row["DeviasiUnit"] = DBNull.Value;
            row["DeviasiJenisPembiayaan"] = DBNull.Value;
            row["DeviasiNamaDebitur"] = DBNull.Value;
            row["DeviasiNamaAO"] = DBNull.Value;
            row["DeviasiTBO"] = DBNull.Value;
            row["KategoriDeviasi"] = DBNull.Value;
            row.EndEdit();
        }
        ...
        public virtual DataTable LoadDataDeviasiMemo()
        {
            return null;
        }
        ...
        protected virtual void UpdateDataDetailPendingGiroSmile(DataSet ds, DXISaveAction saveaction)
        {
        }
        protected virtual void SaveDataDetailDeviasi(DataSet ds, DXISaveAction saveaction)
        {
        }
        protected virtual void SaveDataDetailException(DataSet ds, DXISaveAction saveaction)
        {
        }
    }
}