<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="InternalMemoMaint.aspx.cs" Inherits="DXMNCGUI_INFORMA.Transaction.InternalMemo.InternalMemoMaint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                case 'PRINT':
                    ...
                    switch (Tipe) {
                        ...
                        case 'BIAYA BULANAN':
                            ...
                            break;
                        case 'FREE TEXT MEMO':
                            window.open('../../Shared/DocViewer.aspx?ReportType=IM7&Title=Internal Memorandum - ' + Tipe + '&DocNo=' + DocNo + '&DocKey=' + DocKey);
                            break;
                        case 'MEMO DEVIASI':
                            window.open('../../Shared/DocViewer.aspx?ReportType=IM8&Title=Internal Memorandum - ' + Tipe + '&DocNo=' + DocNo + '&DocKey=' + DocKey);
                            break;
                        case 'MEMO EXCEPTION':
                            window.open('../../Shared/DocViewer.aspx?ReportType=IM9&Title=Internal Memorandum - ' + Tipe + '&DocNo=' + DocNo + '&DocKey=' + DocKey);
                            break;
                    }
                    break;
            }
    ...
    <dx:ASPxPopupControl ID="apcselectdoctype" ClientInstanceName="apcselectdoctype" runat="server" Modal="True" Width="350px" Theme="Aqua"
        PopupHorizontalAlign="WindowCenter" AutoUpdatePosition="true" ShowCloseButton="true" PopupVerticalAlign="WindowCenter" HeaderText="*Please select document type..." AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" Font-Size="Small" CloseAction="CloseButton">
        <ContentCollection>
                        ...
                        <dx:LayoutGroup ShowCaption="False" GroupBoxDecoration="None" ColCount="2">
                            <Items>
                                <dx:LayoutItem Caption="" ShowCaption="false" ColSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxComboBox runat="server" ID="cbDocType" ClientInstanceName="cbDocType" Width="100%" Theme="Aqua">
                                                <Items>
                                                    <dx:ListEditItem Selected="true" Value="1" Text="PEMAKAIAN CASH COLLATERAL" />
                                                    <dx:ListEditItem Value="2" Text="PELEPASAN CROSS COLLATERAL" />
                                                    <dx:ListEditItem Value="3" Text="PENDING GIRO" />
                                                    <dx:ListEditItem Value="4" Text="PERMOHONAN PENGADAAN BARANG & JASA" />
                                                    <dx:ListEditItem Value="5" Text="BIAYA BULANAN" />
                                                    <dx:ListEditItem Value="7" Text="FREE TEXT MEMO" />
                                                    <dx:ListEditItem Value="8" Text="MEMO DEVIASI" />
                                                    <dx:ListEditItem Value="9" Text="MEMO EXCEPTION" />
                                                </Items>
                                            </dx:ASPxComboBox>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                ...
                                <dx:LayoutItem ShowCaption="False" ColSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer6" runat="server">
                                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Next" AutoPostBack="False" UseSubmitBehavior="false" Width="100%" Theme="Aqua">
                                                <ClientSideEvents Click="function(s, e) { apcselectdoctype.Hide();cplMain.PerformCallback('NEW_ENTRY_CONFIRM;' + 'NEW_ENTRY_CONFIRM'); }" />
                                            </dx:ASPxButton>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                <dx:LayoutItem ShowCaption="False" ColSpan="1">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer10" runat="server">
                                            <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Cancel" AutoPostBack="False" UseSubmitBehavior="false" Width="100%" Theme="Aqua">
                                                <ClientSideEvents Click="function(s, e) { apcselectdoctype.Hide(); }" />
                                            </dx:ASPxButton>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
    ...
    <dx:ASPxPopupControl ID="apcApproval" ClientInstanceName="apcApproval" runat="server" Modal="True" Theme="Aqua" Width="900px" CloseAction="CloseButton"
        PopupHorizontalAlign="WindowCenter" ScrollBars="Horizontal" AutoUpdatePosition="true" ShowCloseButton="true" PopupVerticalAlign="WindowCenter" HeaderText="Your approval list.." AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False">
                                ...
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxGridView 
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Name="colPerihal" Caption="Subject" FieldName="MemoPerihal" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="3" Width="20%">
                                                <HeaderStyle Font-Bold="true" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Name="colMemoFrom" Caption="From" FieldName="CreatedMemoBy" ReadOnly="True" ShowInCustomizationForm="true" Visible="true" VisibleIndex="4" Width="20%">
                                                <HeaderStyle Font-Bold="true" />
                                            </dx:GridViewDataTextColumn>
    ...
    <dx:ASPxFormLayout runat="server" ID="FormLayout" ClientInstanceName="FormLayout" Font-Names="Calibri">
        ...
        <Items>
            <dx:LayoutGroup ShowCaption="True" GroupBoxDecoration="HeadingLine" Caption="Internal Memo" ColCount="5">
                <GroupBoxStyle>
                            ...
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxGridView
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colTypeDesc" Caption="Memo Type" FieldName="DocType" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="1">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn Name="colType" Caption="" FieldName="DocValue" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="7" Visible="false">
                                            <HeaderStyle BackColor="WhiteSmoke" Font-Bold="true"/>
                                        </dx:GridViewDataTextColumn>
