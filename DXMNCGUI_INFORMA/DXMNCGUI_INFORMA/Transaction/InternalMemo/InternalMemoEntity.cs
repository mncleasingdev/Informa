...
namespace DXMNCGUI_INFORMA.Transaction.InternalMemo
{
    public class InternalMemoEntity
    {
        ...
        private DataTable myHistoryState;
        private DataTable myDetailDeviasiTable;
        private DataTable myDetailExceptionTable;
        ...
        public DataTable DataTableHistoryState
        {
            get
            {
                return this.myHistoryState;
            }
        }
        ...
        public DataTable DataTableDetailDeviasi
        {
            get
            {
                return this.myDetailDeviasiTable;
            }
        }
        public DataTable DataTableDetailException
        {
            get
            {
                return this.myDetailExceptionTable;
            }
        }
        ...
        public InternalMemoEntity(InternalMemoDB aMemo, DataSet ds, DXIAction action)
        {
            ...
            this.myHistoryState = this.myDataSet.Tables["HistoryState"];
            this.myDetailDeviasiTable = this.myDataSet.Tables["DetailDeviasi"];
            this.myDetailExceptionTable = this.myDataSet.Tables["DetailException"];
        ...
        internal DataRow[] ValidDeviasiRows
        {
            get
            {
                return this.myDetailDeviasiTable.Select("", "Seq", DataViewRowState.Unchanged | DataViewRowState.Added | DataViewRowState.ModifiedCurrent);
            }
        }
        public DeviasiRecord AddDeviasi()
        {
            if (this.myAction == DXIAction.View)
                throw new Exception("Cannot edit read-only Application Lines");
            else
                return this.InternalAddDeviasi(SeqUtils.GetLastSeq(this.ValidDeviasiRows));
        }
        private DeviasiRecord InternalAddDeviasi(int seq)
        {
            DataRow row = this.myDetailDeviasiTable.NewRow();
            DateTime myDate = myInternalMemoDBcommand.localDBSetting.GetServerTime();
            string iUserID = myInternalMemoDBcommand.DBSession.LoginUserID;
            row["DtlKey"] = myInternalMemoDBcommand.DeviasiDtlKeyUniqueKey();
            row["DocKey"] = this.myRow["DocKey"];
            row["Seq"] = (object)seq;
            row["Perihal"] = DBNull.Value;
            row["Alasan"] = DBNull.Value;
            row["Action"] = DBNull.Value;
            row["Deadline"] = DBNull.Value;
            row["Status"] = DBNull.Value;
            row["UpdateBy"] = DBNull.Value;
            row["UpdateDate"] = DBNull.Value;
            row.EndEdit();
            this.myDetailDeviasiTable.Rows.Add(row);
            return new DeviasiRecord(row, this);
        }
        public bool IsDeviasiModified()
        {
            if (this.myDetailDeviasiTable.GetChanges() != null)
                return true;
            else
                return false;
        }
        ...
        internal DataRow[] ValidExceptionRows
        {
            get
            {
                return this.myDetailExceptionTable.Select("", "Seq", DataViewRowState.Unchanged | DataViewRowState.Added | DataViewRowState.ModifiedCurrent);
            }
        }
        public ExceptionRecord AddException()
        {
            if (this.myAction == DXIAction.View)
                throw new Exception("Cannot edit read-only Application Lines");
            else
                return this.InternalAddException(SeqUtils.GetLastSeq(this.ValidExceptionRows));
        }
        private ExceptionRecord InternalAddException(int seq)
        {
            DataRow row = this.myDetailExceptionTable.NewRow();
            DateTime myDate = myInternalMemoDBcommand.localDBSetting.GetServerTime();
            string iUserID = myInternalMemoDBcommand.DBSession.LoginUserID;
            row["DtlKey"] = myInternalMemoDBcommand.ExceptionDtlKeyUniqueKey();
            row["DocKey"] = this.myRow["DocKey"];
            row["Seq"] = (object)seq;
            row["Perihal"] = DBNull.Value;
            row["Alasan"] = DBNull.Value;
            row["MitigasiResiko"] = DBNull.Value;
            row.EndEdit();
            this.myDetailExceptionTable.Rows.Add(row);
            return new ExceptionRecord(row, this);
        }
        public bool IsExceptionModified()
        {
            if (this.myDetailExceptionTable.GetChanges() != null)
                return true;
            else
                return false;
        }
        ...
        public object NoteReturn
        {
            get { return myRow["NoteReturn"]; }
            set { myRow["NoteReturn"] = value; }
        }


        public object DeviasiNoPFK
        {
            get { return myRow["DeviasiNoPFK"]; }
            set { myRow["DeviasiNoPFK"] = value; }
        }
        public object DeviasiUnit
        {
            get { return myRow["DeviasiUnit"]; }
            set { myRow["DeviasiUnit"] = value; }
        }
        public object DeviasiJenisPembiayaan
        {
            get { return myRow["DeviasiJenisPembiayaan"]; }
            set { myRow["DeviasiJenisPembiayaan"] = value; }
        }
        public object DeviasiNamaDebitur
        {
            get { return myRow["DeviasiNamaDebitur"]; }
            set { myRow["DeviasiNamaDebitur"] = value; }
        }
        public object DeviasiNamaAO
        {
            get { return myRow["DeviasiNamaAO"]; }
            set { myRow["DeviasiNamaAO"] = value; }
        }
        public object DeviasiTBO
        {
            get { return myRow["DeviasiTBO"]; }
            set { myRow["DeviasiTBO"] = value; }
        }
        public object KategoriDeviasi
        {
            get { return myRow["KategoriDeviasi"]; }
            set { myRow["KategoriDeviasi"] = value; }
        }
        public object ActionPlan
        {
            get { return myRow["ActionPlan"]; }
            set { myRow["ActionPlan"] = value; }
        }
