...
namespace DXMNCGUI_INFORMA.Transaction.InternalMemo
{
    public class CrossCollRecord
    {
        ...
        public int AssetYear
        {
            get
            {
                return Convert.ToInt32(this.myRow["AssetYear"]);
            }
            set
            {
                this.myRow["AssetYear"] = (object)(value);
            }
        }
        public decimal AssetNTF
        {
            get
            {
                return Convert.ToDecimal(this.myRow["AssetNTF"]);
            }
            set
            {
                this.myRow["AssetNTF"] = (object)(value);
            }
        }
